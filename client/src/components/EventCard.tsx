      ...
      <Link to={`/events/${event.id}`} className="block group h-full">
        <GlassCard className="h-full flex flex-col overflow-hidden transition-all duration-300 group-hover:scale-[1.015] group-hover:shadow-cyan-glow">
          ...
          <div className="p-6 flex flex-col flex-1">
            {/* Location — exactly 1 line reserved. Title is in the cover
            ...
            {/* Summary — exactly 3 lines reserved. Falls back to a
            ...
            <p className="text-white/80 text-sm font-body line-clamp-3 mb-4 min-h-[3.75rem]">
              {event.summary ?? stripTags(event.description).slice(0, 160)}
            </p>
