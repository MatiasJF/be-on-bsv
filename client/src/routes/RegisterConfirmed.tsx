      ...
      <GlassCard strong className="p-8 sm:p-12 text-center">
        ...
        {qrSvg && (
          <details className="mb-6 text-white/60 font-body text-xs">
            ...
            <div
              className="mx-auto mt-3 w-40 h-40 p-3 rounded-xl bg-white/[0.03] border border-white/10"
          ...
          <div className="text-left bg-white/5 border border-white/10 rounded-lg p-4 mb-4">
            ...
            {state.ord_whats_on_chain_url && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 mt-3 px-3 py-1.5 rounded-full bg-bsva-blue text-white text-xs font-display font-semibold hover:bg-bsva-cyan hover:text-white transition-colors"
              >
...
function CertPanel(props: CertPanelProps) {
        ...
        {props.rewardClaimedAt ? (
          ...
          <div>
            ...
            <button
              ...
              className="px-4 py-2 rounded-full bg-bsva-blue text-white font-display font-semibold text-sm hover:bg-bsva-cyan hover:text-white transition-colors disabled:opacity-60"
            >
              {claiming
                ? "Claiming…"
                : !wallet
  ...
  return (
    <div className="mb-6 rounded-xl border border-bsva-cyan/40 bg-gradient-to-br from-bsva-blue/20 to-bsva-cyan/10 p-5 text-left">
      ...
      <div className="text-white/80 font-body text-sm leading-relaxed mb-4">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        {walletError?.includes("out of date") ? (
          <button
            ...
            className="px-4 py-2 rounded-full bg-bsva-cyan text-white font-display font-semibold text-sm hover:bg-white transition-colors"
          >
            Reload page
          </button>
        ) : (
