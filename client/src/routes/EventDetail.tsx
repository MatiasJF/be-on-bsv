  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="w-full bg-white/5 border border-white/10 rounded-lg px-3 py-2.5 text-white font-body placeholder:text-white/30 focus:outline-none focus:border-bsva-blue focus:bg-white transition-colors"
      />
    </label>
  );
}
